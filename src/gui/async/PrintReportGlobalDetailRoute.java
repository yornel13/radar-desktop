...
public class PrintReportGlobalDetailRoute implements Runnable {
    ...
    public PrintReportGlobalDetailRoute(PrintTask listener, JRDataSource dataSource , File file, String fileName, Map<String, Object> parameters) {
    ...
    public void run() {
        try {
            JasperDesign jasperDesign = JRXmlLoader.load(getClass().getResourceAsStream("report/global_route_details.jrxml"));
