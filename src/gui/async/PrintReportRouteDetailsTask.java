...
public class PrintReportRouteDetailsTask implements Runnable {
    ...
    public PrintReportRouteDetailsTask(PrintTask listener, JRDataSource dataSource , File file, String fileName, Map<String, Object> parameters) {
