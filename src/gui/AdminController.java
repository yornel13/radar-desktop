...
@ViewController("view/admin.fxml")
public class AdminController extends BaseController implements EventHandler<MouseEvent> {
    ...
    private void loadAdminListView() throws Exception {
        ...
        for(Admin admin: admins) {
            ...
            ImageView iconAdmin = new ImageView(new Image(getClass()
                    .getResource("img/user_64.png").toExternalForm()));
            if(!admin.getActive()) {
    ...
    private void addAdmin() {
        ...
        floatingButton.setTooltip(
                new Tooltip("Agregar administrador")
        );
